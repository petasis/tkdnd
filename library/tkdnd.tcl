...
namespace eval tkdnd {
	...
	##should use [tk windowingsystem] instead of tcl platform array: OS X returns "unix," but that's not useful because it has its own windowing system, aqua
